...
<TABLE border="0" width="100%">
	...
	<TR>
		<TD><bean:write name="user" property="userName" scope="page"/></TD>
		<TD><bean:write name="user" property="email" scope="page"/></TD>
		<TD><bean:write name="user" property="userTypeName" scope="page"/></TD>
		<TD><bean:write name="user" property="createDate" scope="page"/></TD>
